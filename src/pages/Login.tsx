        ...
        <div className="login-panel">
          ...
          {mode === 'login' && (
            <div className="quick-access-section">
                <div className="divider"><span>OR QUICK ACCESS</span></div>
                <div className="quick-buttons">
                    <button 
                        className="btn btn-outline-alt" 
                        onClick={() => { setEmail('admin@pharmacy.com'); setPassword('admin123'); setRole('admin'); }}
                        disabled={loading}
                    >
                        Sample Pharmacist
                    </button>
                    <button 
                        className="btn btn-outline-alt" 
                        onClick={() => { setEmail('patient@example.com'); setPassword('patient123'); setRole('patient'); }}
                        disabled={loading}
                    >
                        Sample Patient
                    </button>
